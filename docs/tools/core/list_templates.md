...
| --- | --- | --- | :---: | :---: |
| `list_templates` | List document templates (DOCX, Markdown) available to the organization for use with generate_document | `files:read` | — | — |
...
| Tool | Permissions |
| --- | --- |
| `list_templates` | `files:read` |

## Operational metadata

| Tool | Version | Rate limit/min | Timeout (s) | Circuit breaker | Background | Multi-config |
| --- | --- | ---: | ---: | :---: | :---: | :---: |
| `list_templates` | `1.0.0` | 60 | 15 | — | — | — |

## Source files

- [src/mcp_server/tools/core/list_templates.py](src/mcp_server/tools/core/list_templates.py)
